...
map.getView().fit([-8043510.316974, -2042792.798765, -7746800.772390, -1893963.903094], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PROVINCIA DE TACNA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (93 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Este mapa fue elaborado por el curso Cartografia <br />UPN 2025 - 1 <br />Daniel Resurreccion Castillo ';
            }
